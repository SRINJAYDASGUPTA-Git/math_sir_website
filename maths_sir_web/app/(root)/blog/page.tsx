    ...
    <section>
      ...
      <section className="h-full flex flex-col">
        ...
        <div className='flex flex-col md:flex-row'>
          ...
          <div className='w-full md:w-1/2'>
            ...
            <p className='w-[90%] md:w-[75%] ps-10 md:ps-24 pt-5 text-xl md:text-2xl text-black'>
              Explore math's wonders with our insightful blog. From tips and tricks to deep dives, we make math engaging and accessible.
            </p>
          </div>
        ...
        <div className='w-full h-fit p-10 bg-white rounded-t-xl mt-10'>
          <p className='ps-10 text-4xl text-[#232323] font-bold'>Popular Articles</p>
        </div>
        <div className='w-full h-fit p-10 bg-white rounded-b-xl mb-10'>
          <p className='ps-10 text-4xl text-[#232323] font-bold'>Latest News</p>
        </div>
      </section>
    </section>
  )
